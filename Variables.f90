...
type(Differential_MFP), dimension(:), allocatable :: DSF_DEMFP
...
real(8), dimension(:), allocatable :: Out_E_at
...
real(8), dimension(:,:), allocatable :: Out_Elat
real(8), dimension(:,:), allocatable :: Out_Eat_dens  ! [eV/A^3] atom's energy energy
